...
def main():
    ...
    # Custom CSS for green buttons (must come after set_page_config)
    st.markdown("""
    <style>
    /* Green buttons for Start, Stop, and Language selection */
    div.stButton > button {
    ...
    if st.session_state.assistant_active and not st.session_state.language_selected:
        ...
        with col2:
            if st.button("Hindi", key="hindi_button", help="Select Hindi as the language"):
